    ...
    <div className="flex flex-col gap-6 w-full pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 bg-white rounded-3xl border border-slate-200 p-8 shadow-sm flex flex-col min-h-[400px]">
          ...
          <div className="flex-1 border-2 border-dashed border-primary/30 rounded-3xl bg-primary/5 hover:bg-primary/10 transition-colors flex flex-col items-center justify-center p-10 group cursor-pointer relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center relative z-10">
              ...
              <button className="flex items-center justify-center gap-2 bg-primary text-white font-bold px-6 py-3.5 rounded-full hover:bg-primary-dark transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer">
