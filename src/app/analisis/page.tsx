    ...
    <div className="flex flex-col gap-6 w-full pb-10 text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="relative">
          ...
          {isMonthPickerOpen && (
            <div className="absolute top-full mt-2 right-0 bg-white border border-slate-200 rounded-2xl shadow-xl p-4 z-50 w-64 animate-in fade-in zoom-in duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-primary/30 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs font-medium text-slate-500">di seluruh dompet</span>
            </div>
          </div>
        </div>
      </div>
