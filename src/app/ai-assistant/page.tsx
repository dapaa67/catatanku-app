      ...
      <div className="flex flex-col w-full h-full relative overflow-hidden">
        ...
        {!isEmpty && (
          <div className="absolute top-4 right-4 md:right-6 z-10 animate-in fade-in duration-300">
            <button
              onClick={handleReset}
              className="flex items-center gap-1.5 text-[10px] md:text-xs font-semibold text-slate-400 hover:text-primary transition-colors px-3 py-1.5 rounded-xl hover:bg-slate-100 cursor-pointer bg-white border border-slate-100 shadow-sm"
            >
        ...
        <div className="shrink-0 bg-white px-4 pt-2 pb-4 md:pb-6">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-end gap-2 md:gap-3 bg-slate-50 rounded-[2rem] px-4 md:px-5 py-2.5 md:py-3 border border-slate-200 shadow-sm focus-within:border-primary/40 focus-within:ring-4 focus-within:ring-primary/10 transition-all">
